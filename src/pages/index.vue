<template>
    <div>
        <h1 class="text-x1 font-semibold text-info mb-2">Welcome on the tool for help Game Master (GM) to manage their games
        </h1>
        ...
        <div class="card bg-base-300 shadow-lg">
            <div class="card-body">
                ...
                <div class="mb-5">
                    ...
                    <p class=" flex flex-row text-center items-center">You can see our tutorial <NuxtLink
                            class="btn btn-outline btn-secondary ml-2">here</NuxtLink>
                    </p>
                </div>
            </div>
        </div>
