...
import bestiaryGet from "../../bestiary/[universe]/index.get";
import meGet from "../../me.get";
import type { IBestiary, IBestiaryField } from "../../../../types/Game/IGame";
...
export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        const bestiary: IBestiary | undefined = bestiaries.find((bestiary) => {
