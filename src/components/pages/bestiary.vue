...
<template>
    <div class="h-full w-full grid grid-cols-4 gap-4">
        <div class="flex bg-base-300 flex-col items-center py-4">
            Fields
                    ...
                    <table class="table table-zebra">
                        ...
                        <tbody>
                            <tr v-for="field in fields" class="hover bg-base-100">
                                ...
                                <td>
                                    <button class="btn btn-ghost text-secondary px-0" @click="updateField(field)">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                                ...
                                <td>
                                    <button class="btn btn-ghost text-error px-0" @click="removeField(field)">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
